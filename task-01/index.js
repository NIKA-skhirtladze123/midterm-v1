...
class Shape{
   ...
   getInfo(){
      console.log(`This is a ${this.name} and its color is ${this.color}`);
   }
}
...
class Circle extends Shape{
   ...
   getInfo(){
      console.log(`This is a ${this.name} and its color is ${this.color}. It has a radius of ${this.radius}`);
   }
}
...
class Rectangle extends Shape{
   ...
   getInfo(){
      console.log(`This is a ${this.name} and its color is ${this.color}. It has width ${this.width} and height ${this.height}`);
   }
}
// ტესტის შემთხვევები
